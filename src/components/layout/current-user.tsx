...
const CurrentUser = () => {
    ...
    const content = (
        <div style={{
            ...
            <div style={{borderTop:"1px solid #d9d9d9", padding:"4px", display:"flex", flexDirection:"column", gap:"4px"}}>
                <Button style={{ textAlign: "left" }} icon={<SettingOutlined />} type="text" onClick={() => setIsOpen(true)}>
                    Account Settings
                </Button>
            </div>
        </div>
    ...
    return (
        <>
            <Popover placement="bottomRight" trigger="click" overlayInnerStyle={{ padding: 0 }} overlayStyle={{ zIndex: 900 }} content={content}>
